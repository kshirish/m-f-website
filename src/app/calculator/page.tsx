...
export default function CalculatorPage() {
  ...
  return (
    <div className="min-h-screen pt-16">
      {/* Hero Section */}
      <section className="relative py-16 bg-gradient-to-br from-blue-600 to-purple-600 text-white overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600 mb-1">
                      {isCalculated ? formatCurrency(totalInterest) : "$0"}
                    </div>
                    <div className="text-sm text-gray-600">Total Interest</div>
                  </div>
                  <div className="text-center p-4 bg-orange-50 rounded-lg">
                    <div className="text-2xl font-bold text-orange-600 mb-1">
                      {isCalculated ? formatCurrency(totalPayments) : "$0"}
                    </div>
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {isCalculated ? formatCurrency(loanAmount) : "$0"}
                      </span>
                    </div>
                    <div className="flex justify-between">
