  ...
  const services = [
    {
      ...
      description: "Deep knowledge of Melbourne's diverse property landscape",
    },
    {
      title: "Investment Opportunities",
      description: "Capitalize on Melbourne's growth corridors",
    },
    {
      title: "First Home Buyer Support",
      description: "Navigate Melbourne's competitive market with confidence",
    },
    {
      title: "Commercial Finance",
      description: "Fund your Melbourne business ventures",
    },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-green-100 max-w-3xl mx-auto">
              Serving Melbourne's vibrant property market with expert mortgage
              and finance solutions. From the CBD to the outer suburbs, we're
              here for you.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-green-800 hover:bg-gray-100 px-8"
              >
                Get Melbourne Quote
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Building relationships across Melbourne
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {suburbs.map((suburb, index) => (
              <Card
                key={index}
                className="p-4 text-center hover:shadow-md transition-shadow hover:bg-green-50 cursor-pointer"
              >
                <CardContent className="p-0">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 mb-4">
              We serve all Melbourne metropolitan areas!
            </p>
            <Button
              variant="outline"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Our Melbourne specialists understand the local market dynamics,
                from the coffee culture hubs to the emerging growth areas. We
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-green-100">
            Let our Melbourne specialists help you navigate the property market
            and secure the best finance options.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
