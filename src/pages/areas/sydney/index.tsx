  ...
  const services = [
    {
      ...
      description: "Navigate Sydney's competitive market with expert guidance",
    },
    {
    ...
    },
    {
      ...
      description: "Switch to better rates and save on your Sydney property",
    },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Based in the heart of Sydney, we've been helping locals secure
              their dream homes and investment properties across all Sydney
              suburbs for over 15 years.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Located in the heart of Sydney's business district, our team of
                local mortgage specialists is ready to help you navigate
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Level 5, 123 George Street, Sydney NSW 2000
                    </p>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Our Sydney-based experts are here to guide you through every step of
