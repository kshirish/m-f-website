...
interface AdelaideSuburbPageProps {
  suburb: string;
  description: string;
  medianPrice: string;
  growth: string;
...
export default function AdelaideSuburbPage({
  suburb,
  description,
  medianPrice,
  growth,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              {suburb} Home Loans
              <span className="block text-red-300">& Mortgage Services</span>
            </h1>
