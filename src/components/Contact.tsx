      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Ready to take the next step? Contact our friendly team today for a free consultation 
            and personalized quote tailored to your financial needs.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">info@mychoicemortgage.com.au</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Level 5, 123 George Street<br />Sydney NSW 2000</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <Card className="bg-blue-600 text-white border-0 p-6 text-center hover:bg-blue-700 transition-colors cursor-pointer">
            <CardContent className="p-0">
              ...
              <p className="text-blue-100 text-sm mb-4">Speak with an expert immediately</p>
          ...
          <Card className="bg-purple-600 text-white border-0 p-6 text-center hover:bg-purple-700 transition-colors cursor-pointer">
            <CardContent className="p-0">
              ...
              <p className="text-purple-100 text-sm mb-4">Get instant answers online</p>
          ...
          <Card className="bg-green-600 text-white border-0 p-6 text-center hover:bg-green-700 transition-colors cursor-pointer">
            <CardContent className="p-0">
              ...
              <p className="text-green-100 text-sm mb-4">Schedule a consultation</p>
